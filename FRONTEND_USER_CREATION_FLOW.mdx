...
│  - Prompt to connect WhatsApp           │
└─────────────────────────────────────────┘
              ↓
┌─────────────────────────────────────────┐
│  Step 4: WhatsApp OAuth Flow            │
│  - Init OAuth → Get Auth URL            │
│  - Redirect to Meta                     │
│  - Fetch & Select Business Account      │
│  - Fetch & Select Phone Number          │
│  - Save Configuration                   │
└─────────────────────────────────────────┘
              ↓
┌─────────────────────────────────────────┐
...
### Important Notes
- ⚠️ WhatsApp fields are `null` at this stage
...
### Next Step
→ User clicks "Connect WhatsApp" button to start **Step 4**
...
- 🟢 **GREEN** - Best quality, no sending restrictions
- 🟡 **YELLOW** - Good quality, minor restrictions
- 🔴 **RED** - Limited quality, significant restrictions
...
→ Check `META_REDIRECT_URI` environment variable matches frontend callback URL

**State expired error?**
→ Complete OAuth flow within 10 minutes of starting
